...
/**
 * make_shash_node - function dat makes a node for the sorted hash table.
 * @key: pointer to key.
 ...
 * @key: pointer to key & cannot be an empty string.
 * @value: pointer to da value value associated with the key.
 *
 ...
 * @ht: pointer to hash table that look into.
 ...
 * @ht: pointer to da hash table to be printed.
 *
 * Return: NULL.
 */
 ...
 * @ht: pointer to da hash table to be deleted.
 *
 * Return: NULL.
 */
